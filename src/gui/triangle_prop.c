...
void	triangle_init_prop(t_view *s)
{
	...
	s->tri.tri_prop[0] = tf(s, s->space->cl_figures[s->rr.fl.y].t_points[0].x, 2, 32);
	s->tri.tri_prop[1] = tf(s, s->space->cl_figures[s->rr.fl.y].t_points[0].y, 2, 32);
	s->tri.tri_prop[2] = tf(s, s->space->cl_figures[s->rr.fl.y].t_points[0].z, 2, 32);
	s->tri.tri_prop[3] = tf(s, s->space->cl_figures[s->rr.fl.y].t_points[1].x, 2, 32);
	s->tri.tri_prop[4] = tf(s, s->space->cl_figures[s->rr.fl.y].t_points[1].y, 2, 32);
	s->tri.tri_prop[5] = tf(s, s->space->cl_figures[s->rr.fl.y].t_points[1].z, 2, 32);
	s->tri.tri_prop[6] = tf(s, s->space->cl_figures[s->rr.fl.y].t_points[2].x, 2, 32);
