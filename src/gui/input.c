...
void	save_cylinder(t_view *s, int num)
{
	...
	num == 3 ? s->space->cl_figures[s->rr.fl.y].radius = par_input() : 0;
	num == 4 ? s->space->cl_figures[s->rr.fl.y].reflection = par_input() : 0;
	// num == 5 ? s->space->cl_figures[s->rr.fl.y].vector.x = par_input() : 0;
	// num == 6 ? s->space->cl_figures[s->rr.fl.y].vector.y = par_input() : 0;
	// num == 7 ? s->space->cl_figures[s->rr.fl.y].vector.z = par_input() : 0;
...
void	save_plane(t_view *s, int num)
{
	...
	// num == 4 ? s->space->cl_figures[s->rr.fl.y].point.x = par_input() : 0;
	// num == 5 ? s->space->cl_figures[s->rr.fl.y].point.y = par_input() : 0;
	// num == 6 ? s->space->cl_figures[s->rr.fl.y].point.z = par_input() : 0;
}
...
void	save_cube(t_view *s, int num)
{
	...
	// num == 4 ? s->space->cl_figures[s->rr.fl.y].rotation.x = par_input() : 0;
	// num == 5 ? s->space->cl_figures[s->rr.fl.y].rotation.y = par_input() : 0;
	// num == 6 ? s->space->cl_figures[s->rr.fl.y].rotation.z = par_input() : 0;
